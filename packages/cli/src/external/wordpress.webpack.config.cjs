// @ts-nocheck
/**
 * This file is an almost direct copy from wp-scripts. We have opted not to install
 * wp-scripts as it's hard to manage it's many dependencies against our other
 * workspaces.
 */
// TODO: Merge in the relevant rules from this config to our own config directly.
/**
